...
* Créer un nouveau projet javascript vite (ou utiliser celui de la démonstration précédente)
...
* Créer un dossier tests a la racine du projet
...
* Lancer les tests unitaires en cliquant sur la fleche verte
